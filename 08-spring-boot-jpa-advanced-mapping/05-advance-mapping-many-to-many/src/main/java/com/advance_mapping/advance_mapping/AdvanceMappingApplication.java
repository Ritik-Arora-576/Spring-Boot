...
import com.advance_mapping.advance_mapping.entity.*;
...
public class AdvanceMappingApplication {
	...
	public void createCourseAndStudents(AppDAO appDAO){
		Student student1 = new Student("Ritik", "Arora", "Ritikarora656@gmail.com");
		Student student2 = new Student("Yash", "Gupta", "gupta.yash@gmail.com");

		Course course1 = new Course("MERN");
